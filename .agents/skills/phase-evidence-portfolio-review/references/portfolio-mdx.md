...
docs/evidence/<evidence-dir>/
docs/phases/<phase-doc-dir>/assets/
```

현재 프로젝트에서는 `<phase-doc-dir>`과 `<evidence-dir>`가 다를 수 있다. 예를 들어 Phase 7은 `docs/phases/07-pagination`과 `docs/evidence/phase-07`을 함께 사용한다. 반드시 대상 Phase README의 링크와 실제 경로를 확인한다.
